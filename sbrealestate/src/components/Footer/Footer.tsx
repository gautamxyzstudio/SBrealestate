...
const Footer = () => {
  return (
    <footer className='bg-footer_bg w-full h-[480px] px-20 pt-32 bg-no-repeat bg-cover'>
      <div className='w-full flex gap-x-[90px] pb-9'>
        ...
        <div className='flex flex-col gap-y-[24px]'>
          <h2 className='text-background w-full text-base-20px font-bold'>Quick Links</h2>
        ...
        <div className='flex flex-col gap-y-[24px]'>
          ...
          <div className='flex flex-col gap-3'>
            <div className='flex flex-row gap-1'>
              <h4 className='text-background text-20px font-bold'>Follow us</h4>
        ...
        <div className='flex flex-col gap-y-[24px]'>
        <h2 className='text-background w-full text-base-20px font-bold'>Location</h2>
          <div className='text-background text-base-16px flex flex-col gap-y-[12px]'>
            <div className='flex flex-row gap-x-[8px]'>
              <Image src={Icons.Location} alt='' className='w-[22px] h-[22px]'/>
              <p className='text-background w-full text-base-16px '>104-13049 76 Ave Surrey, BC V3W 2V7</p>
            </div>
      ...
      <div className='w-full flex pt-5 pb-5 justify-between border-t border-borderStroke'>
        <p className='text-background text-base-16px'>2025 Sukh Brar Real Estate Team, All Rights Reserved.</p>
        <p className='text-background text-base-16px'>Privacy Policy</p>
      </div>
    </footer>
  )
}
